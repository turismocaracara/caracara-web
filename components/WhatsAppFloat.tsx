...
export default function WhatsAppFloat() {
  return (
    ...
    >
      ...
      {/* Tooltip */}
      <span className="absolute right-16 bg-gray-800 text-white text-xs font-medium px-3 py-1.5 rounded-lg whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none">
        Escríbenos
      </span>
    </a>
  );
